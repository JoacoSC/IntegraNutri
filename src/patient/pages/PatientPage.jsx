...
export const PatientPage = () => {
    ...
    const { weight, stature, anamnesis, physical_exam, diagnosis, indications, graphs, onInputChange } = useForm(defaultPatient);
    ...
    const onWeightStatureSubmit = ( event ) => {
    ...
    const onPatientConsultationSubmit = ( event ) => {
        event.preventDefault();
                        ...
                        <form className="form-style" onSubmit={ onWeightStatureSubmit } >
                            ...
                            <div className="patient-weight">
                                ...
                                <div className="weight">
                                    <input className="weight-value" name="weight" type="text" defaultValue={ defaultPatient.weight } onChange={ onInputChange }/>
                            ...
                            <div className="patient-stature">
                                ...
                                <div className="stature">
                                    <input className="stature-value" name="stature" type="text" defaultValue={ defaultPatient.stature } onChange={ onInputChange }/>
