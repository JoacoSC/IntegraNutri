                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="biologicalSex" value={ biologicalSex } readOnly/>
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Etnia
                                    </label>
                                    <select className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputEtnia" placeholder='80' onChange={onInputChange}>
                                ...
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="ageText" value={ ageText } readOnly />
                                </div>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="weight" value={ Peso } readOnly />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Talla
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="stature" value={ stature[stature.length - 1].A } readOnly />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        IMC
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="imc" value={ imcValue } readOnly />
                                </div>
                            </div>
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueTricipital" placeholder='80' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Subescapular (mm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueSubescapular" placeholder='80' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Crestailiaca (mm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueCrestailiaca" placeholder='80' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueBicipital" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Supraespinal (mm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueSupraespinal" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Abdominal (mm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueAbdominal" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input w-50">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPliegueMuslo" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input w-50">
                                    <label className="input-label">
                                        Pierna (mm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPlieguePierna" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroBrazoRelajado" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Brazo contraído (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroBrazoContraido" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Pierna (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroPierna" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroMuslo" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Cintura (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroCintura" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Cadera (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputPerimetroCadera" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                        ...
                        {/* <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CCOMSMedicion" placeholder='80' value={ CircunferenciaCintura } readOnly/>
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Clasificación
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" name="CCOMSRating" value={CCOMSRating} readOnly />
                                </div>
                            </div>
                            <label className="input-label">
                                Referencia: OMS 2008
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="modal-content-row-input">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputDiametroMuneca" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Húmero (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputDiametroHumero" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                                <div className="modal-content-row-input">
                                    <label className="input-label">
                                        Femur (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="InputDiametroFemur" placeholder='90' onChange={handleCommaToPointChange}  />
                                </div>
                            </div>
                        </div>
                        <div className='modal-content-row modal-content-row-background'>
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CCMINSALMedicion" placeholder='80' value={ SomatocartaIP } readOnly />
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        X
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CCMINSALMedicion" placeholder='80' value={ SomatocartaX } readOnly />
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Y
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CCMINSALMedicion" placeholder='80' value={ SomatocartaY } readOnly />
                                </div>
                            </div>
                            ...
                            <div className="form-group custom-gap-1">
                                ...
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" name="CCMINSALRating" value={ Endomorfia } readOnly />
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Mesomorfia
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" name="CCMINSALRating" value={ Mesomorfia } readOnly />
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Ectomorfia
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" name="CCMINSALRating" value={ Ectomorfia } readOnly />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CCMINSALMedicion" placeholder='80' value={ CircunferenciaCintura } readOnly />
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Clasificación
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CinturaMedicion" placeholder='80' value={ CircunferenciaCintura } readOnly/>
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Circunferencia de cadera (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CaderaMedicion" placeholder='95' value={ CircunferenciaCadera } readOnly/>
                                </div>
                            </div>
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                        ...
                        <div className='modal-content-row modal-content-row-background'>
                            ...
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
                                    ...
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="CinturaMedicionKoch" placeholder='80' value={ CircunferenciaCintura } readOnly/>
                                </div>
                                <div className="form-item w-50 pr-8">
                                    <label className="input-label">
                                        Estatura (cm)
                                    </label>
                                    <input className="input-text-style h-2 custom-text-align-center" type="text" step=".01" name="Talla" placeholder='95' value={Talla} readOnly />
                                </div>
                            </div>
                            <div className="form-group custom-gap-1">
                                <div className="form-item w-50 pr-8">
